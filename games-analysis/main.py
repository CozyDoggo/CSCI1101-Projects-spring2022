...
plt.scatter(df_main["first_release_date"], df_main["critic_rating_value"], color = "blue", label = "Critic Ratngs")
...
plt.bar(df_hype.index + BAR_WIDTH / 2, df_hype["total_hypes"], color = "red", width = BAR_WIDTH)
